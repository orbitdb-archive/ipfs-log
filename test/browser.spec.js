...
if (!isNode) {
  const keyA = import('./fixtures/keys/signing-keys/userA.json')
  const keyB = import('./fixtures/keys/signing-keys/userB.json')
  const keyC = import('./fixtures/keys/signing-keys/userC.json')
  const keyD = import('./fixtures/keys/signing-keys/userD.json')
  const keyE = import('./fixtures/keys/identity-keys/0358df8eb5def772917748fdf8a8b146581ad2041eae48d66cc6865f11783499a6.json')
  const keyF = import('./fixtures/keys/identity-keys/032f7b6ef0432b572b45fcaf27e7f6757cd4123ff5c5266365bec82129b8c5f214.json')
  const keyG = import('./fixtures/keys/identity-keys/02a38336e3a47f545a172c9f77674525471ebeda7d6c86140e7a778f67ded92260.json')
  const keyH = import('./fixtures/keys/identity-keys/03e0480538c2a39951d054e17ff31fde487cb1031d0044a037b53ad2e028a3e77c.json')
