...
var _entry = _interopRequireDefault(require("./entry.js"));
var _entryIo = _interopRequireDefault(require("./entry-io.js"));
...
var fetchAll = _entryIo["default"].fetchAll,
  fetchParallel = _entryIo["default"].fetchParallel;
var compare = _entry["default"].compare,
  isEntry = _entry["default"].isEntry;
      ...
      var _toMultihash = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(ipfs, log) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              if (!(0, _index.isDefined)(format)) format = 'dag-cbor';
            ...
            case 8:
              return _context.abrupt("return", _index.io.write(ipfs, format, log.toJSON(), {
                links: IPLD_LINKS
              }));
            case 9:
            case "end":
      ...
      var _fromMultihash = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(ipfs, hash, _ref2) {
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              _context2.next = 7;
              return _index.io.read(ipfs, hash, {
                links: IPLD_LINKS
              });
            case 7:
            ...
            case 10:
              ...
              _context2.next = 14;
              return fetchAll(ipfs, logData.heads, {
                length: length,
                exclude: exclude,
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 5:
              ...
              _context3.next = 9;
              return fetchParallel(ipfs, hashes, {
                length: length,
                exclude: exclude,
                shouldExclude: shouldExclude,
                timeout: timeout,
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              ...
              _context4.next = 7;
              return fetchParallel(ipfs, headHashes, {
                length: length,
                timeout: timeout,
                concurrency: concurrency,
                onProgressCallback: onProgressCallback
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              throw (0, _logErrors.IPFSNotDefinedError)();
            case 3:
              if ((0, _index.isDefined)(sourceEntries)) {
                _context5.next = 5;
                break;
              }
            ...
            case 12:
              ...
              uniques = (0, _index.findUniques)(combined, 'hash').sort(compare); // Cap the result at the right size by taking the last n entries
              ...
              missingSourceEntries = (0, _index.difference)(sliced, sourceEntries, 'hash');
